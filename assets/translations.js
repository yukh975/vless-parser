const TRANSLATIONS = {
    en: {
        ...
        dns_enabled_label:      'Enable custom DNS',
        dns_preset_google:      'Google DoH',
        dns_preset_cloudflare:  'Cloudflare DoH',
        dns_preset_yandex:      'Yandex DoH',
        dns_preset_custom:      'Custom...',
        add_dns_btn:            '+ Add server',
        dns_fallback_label:     'Fallback DNS server',
        dns_fallback_hint:      'Used when no domain rules match (e.g. 8.8.8.8)',
